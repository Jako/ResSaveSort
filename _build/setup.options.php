...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install ResSaveSort</h2>

        <p>Thanks for installing ResSaveSort. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade ResSaveSort</h2>

        <p>ResSaveSort will be upgraded. This open source extra was developped by
